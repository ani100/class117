...
function preload() {
    ...
    teachable = ml5.imageClassifier("DoodleNet",find);
    ...
    function find() {
        ...
        console.log("the doodle net is loaded");    
    }
    
    function identify() {
        teachable.classify(canvas,display);
    }
    
    function display(error,results) {
